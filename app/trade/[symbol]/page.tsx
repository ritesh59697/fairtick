  ...
  if (!stock) {
    return (
      <div className="text-center py-20 space-y-4">
        ...
        <Link href="/markets" className="inline-block px-4 py-2 bg-blue-600 rounded-lg text-xs font-semibold text-white">
          Back to Markets
        </Link>
      </div>
    );
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 pt-8 md:pt-10 pb-20 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <Link
          href="/markets"
          className="inline-flex items-center gap-1.5 text-xs text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-zinc-200 transition"
        >
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="px-3 py-1.5 rounded-lg bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 shadow-sm flex items-center gap-2.5 text-xs">
            <span className="text-slate-600 dark:text-zinc-400 text-[11px]">Simulate Market Open:</span>
            <ToggleSwitch
              checked={forceOpen}
              onChange={(next) => {
                setForceOpen(next);
          ...
          <div className="px-3 py-1.5 rounded-lg bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 shadow-sm flex items-center gap-2.5 text-xs">
            <span className="text-slate-600 dark:text-zinc-400 text-[11px]">Demo Stale Feed:</span>
            <ToggleSwitch
              checked={forceStale}
              onChange={(next) => {
                setForceStale(next);
      ...
      {!hasBuilderCode && (
        <div className="p-4 rounded-xl bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/30 flex items-start gap-3 text-amber-900 dark:text-amber-300 text-xs shadow-sm">
          <AlertTriangle className="w-5 h-5 shrink-0 text-amber-600 dark:text-amber-400 mt-0.5" />
          <div className="space-y-1">
            <div className="font-bold text-amber-950 dark:text-amber-200">Builder Code Setup Required (Read-Only Mode)</div>
      ...
      {!hasPool && (
        <div className="p-4 rounded-xl bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 flex items-start gap-3 text-slate-700 dark:text-zinc-300 text-xs shadow-sm">
          <Info className="w-5 h-5 shrink-0 text-slate-500 dark:text-zinc-400 mt-0.5" />
          <div className="space-y-1">
            <div className="font-bold text-slate-900 dark:text-zinc-200">No Verified Onchain Pool Available</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-7 space-y-4">
          <div className="bg-white dark:bg-zinc-900/80 border border-slate-200 dark:border-zinc-800 rounded-2xl p-6 space-y-5 shadow-xl shadow-slate-200/50 dark:shadow-none">
            {/* Asset Identity */}
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2.5">
                    <h1 className="text-2xl font-black text-slate-900 dark:text-zinc-100">{stock.symbol}</h1>
                    <span className="text-xs font-mono text-slate-700 dark:text-zinc-400 bg-slate-100 dark:bg-zinc-800 border border-slate-200 dark:border-transparent px-2 py-0.5 rounded">
                      {stock.underlying}
                    </span>
                  </div>
                  <p className="text-xs text-slate-600 dark:text-zinc-400 mt-1">{stock.name}</p>
                  <p className="text-[10px] font-mono text-slate-500 dark:text-zinc-500 mt-0.5 select-all">
            ...
            <div className="p-4 rounded-xl bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-850 space-y-3">
              <div className="flex items-center justify-between text-xs">
                <span className="text-slate-600 dark:text-zinc-400">DEX Price vs Fair Value</span>
                <span
              ...
              {/* Progress bar visual */}
              <div className="relative h-2 rounded-full bg-slate-200 dark:bg-zinc-800 overflow-hidden">
                <div
              ...
              <div className="flex items-center justify-between text-[11px] text-slate-500 dark:text-zinc-500 font-mono">
                <span>0 bps (Par)</span>
            ...
            <div className="grid grid-cols-2 gap-3 text-xs">
              <div className="p-3 rounded-xl bg-slate-50 dark:bg-zinc-950/60 border border-slate-200 dark:border-zinc-850 space-y-1">
                <span className="text-slate-500 dark:text-zinc-400 text-[11px]">Onchain DEX Mid</span>
                <div className="font-mono font-bold text-slate-900 dark:text-zinc-100 text-base">
                  ${dexPrice > 0 ? dexPrice.toFixed(2) : "—"}
                </div>
                <span className="text-[10px] text-slate-500 dark:text-zinc-500">Route: {stock.primaryDex} Pool</span>
              </div>

              <div className="p-3 rounded-xl bg-slate-50 dark:bg-zinc-950/60 border border-slate-200 dark:border-zinc-850 space-y-1">
                <span className="text-slate-500 dark:text-zinc-400 text-[11px]">Chainlink Total-Return</span>
                <div className="font-mono font-bold text-slate-900 dark:text-zinc-100 text-base">
                  ${fairPrice > 0 ? fairPrice.toFixed(2) : "—"}
                </div>
                <span className="text-[10px] text-slate-500 dark:text-zinc-500">Includes corporate splits</span>
              </div>

              <div className="p-3 rounded-xl bg-slate-50 dark:bg-zinc-950/60 border border-slate-200 dark:border-zinc-850 space-y-1">
                <span className="text-slate-500 dark:text-zinc-400 text-[11px]">B20 Multiplier</span>
                <div className="font-mono font-bold text-slate-900 dark:text-zinc-100 text-base">
                  {(Number(multiplierWad) / 1e18).toFixed(4)}x
                </div>
                <span className="text-[10px] text-slate-500 dark:text-zinc-500">1 Token = {(Number(multiplierWad) / 1e18).toFixed(2)} Shares</span>
              </div>

              <div className="p-3 rounded-xl bg-slate-50 dark:bg-zinc-950/60 border border-slate-200 dark:border-zinc-850 space-y-1">
                <span className="text-slate-500 dark:text-zinc-400 text-[11px]">Feed Freshness</span>
                <div className="font-mono font-bold text-slate-900 dark:text-zinc-100 text-base truncate">
            ...
            {isHeld && (
              <div className="p-3.5 rounded-xl bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/25 space-y-2 text-xs">
        ...
        <div className="lg:col-span-5 space-y-4">
          <div className="bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 rounded-2xl p-6 space-y-5 shadow-xl shadow-slate-200/50 dark:shadow-none">
            {/* Side Switcher */}
            <div className="grid grid-cols-2 p-1 rounded-xl bg-slate-100 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 text-xs font-semibold">
              <button
                onClick={() => setSide("BUY")}
                className={`py-2 rounded-lg transition ${
                  side === "BUY" ? "bg-blue-600 text-white shadow" : "text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-zinc-200"
                }`}
              >
                Buy with USDC
              </button>
              <button
                ...
                className={`py-2 rounded-lg transition ${
                  side === "SELL" ? "bg-slate-800 text-white shadow" : "text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-zinc-200"
                }`}
              >
                Sell to USDC
              </button>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-xs">
                <span className="text-slate-600 dark:text-zinc-400 font-medium">You Pay:</span>
              ...
              <div className="relative rounded-xl bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 focus-within:border-blue-500 p-3 flex items-center justify-between transition">
                <input
                  type="number"
                  value={amount}
                  onChange={(e) => setAmount(e.target.value)}
                  placeholder="0.0"
                  className="bg-transparent text-xl font-mono font-bold text-slate-900 dark:text-zinc-100 focus:outline-none w-full"
                />
                <span className="text-xs font-bold font-mono px-2 py-1 rounded bg-slate-200 dark:bg-zinc-800 text-slate-800 dark:text-zinc-300">
            ...
            <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-zinc-950/70 border border-slate-200 dark:border-zinc-850 space-y-2 text-xs">
              <div className="flex items-center justify-between">
                <span className="text-slate-600 dark:text-zinc-400">Expected Tokens:</span>
              ...
              <div className="flex items-center justify-between border-t border-slate-200 dark:border-zinc-850/60 pt-2">
            ...
            <div className="space-y-2 pt-2 border-t border-slate-200 dark:border-zinc-800/80 text-xs">
              <div className="flex items-center justify-between">
                <span className="text-slate-600 dark:text-zinc-400">Max Allowed Premium:</span>
                    ...
                    <button
                      ...
                      className={`px-2 py-0.5 rounded text-[11px] font-mono transition ${
                        maxPremiumBps === bps
                          ...
                          : "bg-slate-100 dark:bg-zinc-800 text-slate-600 dark:text-zinc-400 border border-slate-200 dark:border-transparent hover:text-slate-900 dark:hover:text-zinc-200"
                      }`}
                    >
                      {bps} bps
                    </button>
              ...
              <div className="flex items-center justify-between text-slate-600 dark:text-zinc-400">
                ...
                <span className="font-mono text-[11px]">
                  {hasBuilderCode ? (
                    <span className="text-blue-600 dark:text-blue-400">"{BUILDER_CODE_ENV}" (ERC-8021)</span>
                  ) : (
                    <span className="text-amber-600 dark:text-amber-400 font-medium">Unconfigured (Read-Only)</span>
                  )}
                </span>
              </div>
            </div>
            ...
            {errorMessage && (
              <div className="p-3 rounded-xl bg-rose-50 dark:bg-red-500/10 border border-rose-200 dark:border-red-500/30 text-xs text-rose-800 dark:text-red-300 flex items-start gap-2">
                <AlertTriangle className="w-4 h-4 text-rose-600 dark:text-red-400 shrink-0 mt-0.5" />
            ...
            <div>
              {!hasPool ? (
                <button
                  disabled
                  className="w-full py-3.5 rounded-xl bg-slate-100 dark:bg-zinc-850 text-slate-400 dark:text-zinc-500 font-semibold text-xs flex items-center justify-center gap-2 cursor-not-allowed border border-slate-200 dark:border-zinc-750"
                >
                ...
                <button
                  disabled
                  className="w-full py-3.5 rounded-xl bg-amber-100 dark:bg-amber-950/60 border border-amber-300 dark:border-amber-500/40 text-amber-800 dark:text-amber-300 font-semibold text-xs flex items-center justify-center gap-2 cursor-not-allowed"
                >
                ...
                <button
                  disabled
                  className="w-full py-3.5 rounded-xl bg-slate-100 dark:bg-zinc-800 text-slate-400 dark:text-zinc-500 font-semibold text-xs flex items-center justify-center gap-2 cursor-not-allowed border border-slate-200 dark:border-zinc-700"
                >
                  <Lock className="w-3.5 h-3.5" />
                ...
                <button
                  disabled
                  className="w-full py-3.5 rounded-xl bg-rose-100 dark:bg-rose-950/60 border border-rose-300 dark:border-rose-500/40 text-rose-700 dark:text-rose-300 font-semibold text-xs flex items-center justify-center gap-2 cursor-not-allowed"
                >
                  <AlertTriangle className="w-3.5 h-3.5" />
                ...
                <button
                  disabled
                  className="w-full py-3.5 rounded-xl bg-amber-100 dark:bg-amber-950/50 border border-amber-300 dark:border-amber-500/40 text-amber-800 dark:text-amber-300 font-semibold text-xs flex items-center justify-center gap-2 cursor-not-allowed"
                >
            ...
            <p className="text-[10px] text-slate-500 dark:text-zinc-500 text-center">
